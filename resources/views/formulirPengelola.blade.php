...
<html lang="en">
  ...
  <div class="container">
    ...
    <form action="/insertFormulirPengelola" method="post" enctype="multipart/form-data">
      ...
      <div class=" inputProdukAlam">
        <div class="input-group row">
          <input type="text" class="form-control ml-3 classProdukAlam" name="produkAlam_1" placeholder="Nama produk alam">
        </div>
      </div>
      ...
      <div class=" inputProdukBudaya">
        <div class="input-group row">
          <input type="text" class="form-control ml-3 classProdukBudaya" name="produkBudaya_1" placeholder="Nama produk budaya">
        </div>
      </div>
      ...
      <div class=" inputProdukBuatan">
        <div class="input-group row">
          <input type="text" class="form-control ml-3 classProdukBuatan" name="produkBuatan_1" placeholder="Nama produk buatan">
        </div>
      </div>
      ...
      <div class="form-check">
        <input class="form-check-input" type="checkbox" value="Toilet" id="toilet" name="toilet">
      ...
      <div class="input-group row">
        ...
        <input type="text" class="form-control ml-3 classFasilitas" name="fasilitasLain_1" >
      </div>
      </div>
      ...
      <div class="input-group row">
        ...
        <input type="text" class="form-control ml-3 classLayanan" name="layananLain_1" >
      </div>
      </div>
